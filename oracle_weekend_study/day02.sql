...
CREATE TABLE TBL_OWNER(
	...
	OWNER_NAME VARCHAR2(1000) CONSTRAINT REQUIRE_NAME NOT NULL,
	OWNER_AGE NUMBER,
	OWNER_ADDRESS VARCHAR2(1000) CONSTRAINT REQUIRE_ADDRESS NOT NULL,
	OWNER_PHONE_NUMBER VARCHAR2(1000) CONSTRAINT REQUIRE_PHONE_NUMBER NOT NULL CONSTRAINT UNIQUE_OWNER UNIQUE
);
...
CREATE TABLE TBL_PET(
	...
	PET_SPECIES VARCHAR2(1000) CONSTRAINT REQUIRE_SPECIES NOT NULL,
	PET_NAME VARCHAR2(1000) CONSTRAINT REQUIRE_PET_NAME NOT NULL,
	PET_AGE NUMBER CONSTRAINT REQUIRE_AGE NOT NULL,
	PET_ILL_NAME VARCHAR2(1000) CONSTRAINT REQUIRE_ILL_NAME NOT NULL,
	OWNER_ID NUMBER CONSTRAINT REQUIRE_OWNER_ID NOT NULL,
...
(OWNER_ID, OWNER_NAME, OWNER_AGE, OWNER_ADDRESS, OWNER_PHONE_NUMBER)
VALUES(SEQ_OWNER.NEXTVAL, '김세윤', 40, '경기도 남양주시', '01012341238');
...
(PET_ID, PET_SPECIES, PET_NAME, PET_AGE, PET_ILL_NAME, OWNER_ID)
VALUES(SEQ_PET.NEXTVAL, '개', '멍이', 10, '피부병', 5);

INSERT INTO HR.TBL_PET
(PET_ID, PET_SPECIES, PET_NAME, PET_AGE, PET_ILL_NAME, OWNER_ID)
VALUES(SEQ_PET.NEXTVAL, '고양이', '냥이', 5, '피부병', 1);

INSERT INTO HR.TBL_PET
(PET_ID, PET_SPECIES, PET_NAME, PET_AGE, PET_ILL_NAME, OWNER_ID)
VALUES(SEQ_PET.NEXTVAL, '고양이', '냥냥이', 4, '피부병', 3);

/*두 마리 이상의 반려동물 보호자의 핸드폰 번호를 다른 번호로 변경*/
UPDATE TBL_OWNER 
SET OWNER_PHONE_NUMBER = '010'
(
	SELECT COUNT(OWNER_ID) FROM TBL_PET
	GROUP BY OWNER_ID
	HAVING COUNT(OWNER_ID) > 1
)
UPDATE HR.TBL_OWNER
SET OWNER_PHONE_NUMBER = '01098765432'
WHERE OWNER_ID = 1;


/*반려 동물을 키우고 있는 보호자를 병원 보호자 명단에서 삭제*/
DELETE FROM HR.TBL_PET
WHERE PET_ID=4;


DELETE FROM HR.TBL_OWNER
WHERE OWNER_ID=3;
